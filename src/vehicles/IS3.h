...
const uint8_t escRampTimeFirstGear = 40;  // determines, how fast the acceleration and deceleration happens (about 15 - 25, 20 for King Hauler)
...
const uint8_t escRampTimeThirdGear = 100; // 75 for King Hauler
